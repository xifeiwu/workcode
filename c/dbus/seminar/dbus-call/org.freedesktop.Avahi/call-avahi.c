...
main (int argc, char **argv)
{
  ...
  if (!dbus_g_proxy_call (remote_object, "GetHostName", &error,
              G_TYPE_INVALID, G_TYPE_STRING, &introspect_data, G_TYPE_INVALID))
    lose_gerror ("Failed to call GetHostName", error);
  printf("sum is %s\n", introspect_data);
