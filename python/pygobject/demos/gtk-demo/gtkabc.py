...
#        print("relpath : %s | packagename : %s | modulename : %s" % (relpath, packagename, modulename))
...
class DemoTreeStore(Gtk.TreeStore):
    ...
    def __init__(self, *args):
        ...
        file_list_sorted = self._list_dir(DEMOCODEDIR)
#        print("DEMOCODEDIR : %s" % DEMOCODEDIR)
...
#            print("fullpath : %s, initfile : %s" % (fullpath, initfile))
...
#                print("fullpath : %s | relpath : %s | parentname : %s" % (fullpath, os.path.relpath(fullpath, DEMOCODEDIR), parentname))
                if parentname:
...
#        self._print_list(demo_file_list)
#        print("Contents of list - sorted:")
#        self._print_list(sorted(demo_file_list, key=str.lower))
